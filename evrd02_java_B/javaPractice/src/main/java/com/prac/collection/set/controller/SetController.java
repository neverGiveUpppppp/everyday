...
//		HashSet set = new HashSet(); // 노란줄 원인 : 제네릭 지정안해서
    ...
    public void doSet2() {
        ...
        System.out.println("set22 : "+set2); //  [초코(2.1kg), 콩이(8.3kg), 두부(5.0kg), 로이(6.1kg), 공주(5.2kg)]
        ...
        System.out.println("set3 : "+set3); // 결과값 오름차순 정렬됨 : [너는, 뭐니, 싫어?, 안녕, 어때?, 왜?, 우리, 이름이, 제발.., 지내자, 친하게]
        // TreeSet이 정렬시킨다
...
//		}
        ...
        for(int i=0; i<list.size();i++) {
            System.out.println("ArrayList<Dog> list : "+list.get(i));
        }
