...
public class Pagination {
	...
	public static PageInfo getPageInfo(int currentPage, int listCount) {
		...
		startPage = (currentPage - 1)/pageLimit * pageLimit + 1; // 수학적 계산으로는 cp만 나오지만 컴퓨터로 계산하면 starPage가 나옴. 수학계산이랑 컴퓨터수학계산이랑 우선순위가 다름
		// 6.9 강의 11:17
		...
		PageInfo pageInfo = new PageInfo(currentPage, listCount, pageLimit, maxPage, startPage, endPage, boardLimit);
