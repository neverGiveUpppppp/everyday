...
public class UserActivitySearchExample {
    ...
    public static void main(String[] args) {
        try {
            ...
            String viewId = "300387543";

            // 서비스 초기화
            AnalyticsReporting service = initializeAnalyticsReporting(keyFilePath);
//            Analytics analytics = new Analytics(keyFilePath);
            // 사용자 활동 데이터 검색
...
//                .setApplicationName("Your-Application-Name")
                .setApplicationName("tryTests_attribute")
                .build();
    }
