 ...
 * }</pre>
 */
public class RunReportApplicated { // 보고서 객체 생성하는 RunReportRequest 오브젝트(Object)
...
//                            .addDateRanges(DateRange.newBuilder().setStartDate("2024-01-28").setEndDate("today"))  // 1,2,3,5일 데이터 나옴
                            .build();
...
//            printout(response);
            ...
            System.out.println("====================================================================");
            Row row1 = response1.getRows(0);
            Row row2 = response2.getRows(0);
...
//            printoutApplicated(response2);
    ...
    static void printoutApplicated(RunReportResponse response){
        System.out.println("====================================================================");
...
//        int allVisitor = 0;
        ...
        for (Row row : response.getRowsList()) {
            ...
            todayVisitor = row.getMetricValues(0).getValue();
            allVisitor = row.getMetricValues(0).getValue();
            System.out.println("todayVisitor : " + todayVisitor);
            System.out.println("allVisitor : " + allVisitor);
