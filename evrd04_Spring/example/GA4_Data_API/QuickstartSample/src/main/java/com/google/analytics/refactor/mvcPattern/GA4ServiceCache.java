...
//    }
    ...
    @Autowired
    public GA4ServiceCache(AnalyticsDataClient analyticsData, CacheManager cacheManager) {
        this.analyticsData = analyticsData;
    ...
    public String ga4CacheAll() {
        ...
        if (allCnt == null) {
            String all = getVisitors(propertyId, "2024-01-28", "today", false); // ga4VisitorNum()에서 이미 두 수를 다 가져옴
            // 캐시에 저장
